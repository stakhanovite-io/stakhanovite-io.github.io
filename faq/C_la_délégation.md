...
**Un groupe d'enjeu peut donc être vu comme une coopérative.** Les récompenses obtenues seront alors partagées proportionnellement à la délégation de chacun au sein du groupe d'enjeu.

**Le groupe d'enjeu prélèvera une commission pour ce service**.
